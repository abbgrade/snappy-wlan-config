...
func (config *Controller) Export() {
	...
	for interfaceName, networks := range interfaces {
		...
		// add a file header
		fmt.Fprintf(wifiConfigFile, "# DO NOT CHANGE THIS FILE\n")
		fmt.Fprintf(wifiConfigFile, "# This file is generated by snappy-wlan-config,\n")
		fmt.Fprintf(wifiConfigFile, "# manual changes may become reversed.\n")
		fmt.Fprintf(wifiConfigFile, "\n")

		for _, network := range networks {

			// add each network configuration
			export := NewWifiExport(&network)
			fmt.Fprintf(wifiConfigFile, export.Dump())
			fmt.Fprintf(wifiConfigFile, "\n")
			wifiConfigFile.Sync()
		}
		...
		// add a file header
		fmt.Fprintf(inetConfigFile, "# DO NOT CHANGE THIS FILE\n")
		fmt.Fprintf(inetConfigFile, "# This file is generated by snappy-wlan-config,\n")
		fmt.Fprintf(inetConfigFile, "# manual changes may become reversed.\n")
		fmt.Fprintf(inetConfigFile, "\n")

		for network := range networkExports.Iter() {

			fmt.Fprintf(inetConfigFile, network.(string))
			fmt.Fprintf(inetConfigFile, "\n")
